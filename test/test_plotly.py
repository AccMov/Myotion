...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(1170, 829)
        self.centralwidget = QWidget(MainWindow)
        self.centralwidget.setObjectName(u"centralwidget")
        self.ExitButton = QPushButton(self.centralwidget)
        self.ExitButton.setObjectName(u"ExitButton")
        self.ExitButton.setGeometry(QRect(920, 660, 181, 61))
        
        self.Render = QPushButton(self.centralwidget)
        self.Render.setObjectName(u"Render")
        self.Render.setGeometry(QRect(720, 660, 181, 61))
        ...
        self.plot_widget = QWebEngineView(self.centralwidget)
        self.plot_widget.setGeometry(QRect(30, 40, 651, 441))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.Render.setText(QCoreApplication.translate("MainWindow", u"Render", None))
